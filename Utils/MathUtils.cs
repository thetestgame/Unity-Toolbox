...
namespace UnityToolbox.Utils
{
    ...
    /// <summary>The Math ulity class that contains methods to help with mapping and angles and a really nifty method for framerate-independent eased lerping.</summary>
    public static class MathUtils
    {
        ...
        public static float GetCenterAngleDeg(float angle1, float angle2) => angle1 + Mathf.DeltaAngle(angle1, angle2) / 2f;
