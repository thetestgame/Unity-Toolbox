...
namespace UnityToolbox.Utils
{
    ...
    /// <summary>Utility extensions for the <see cref="IEnumerable{T}"/> and <see cref="List{T}"/> objects for use in LINQ operations.</summary>
    public static class IEnumerableExtensions
    {
        ...
        /// <summary>Returns the component nearest to the referencePoint and in minimum/maximum range.</summary>
        ...
        /// <summary>Shuffles an array in place.</summary>
